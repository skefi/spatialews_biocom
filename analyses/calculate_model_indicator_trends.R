# Calculates the trend (slope) of each of the spatial metrics along the aridity gradient in the model
...
filename = paste0("trends_model_Nperm_",NPERM,"_Bootn_",BOOTN,".rda")
save(model_trends, model_trends_med, model_trends_all, model_trends_diffs_distribs, model_trends_diffs, 
