#' Function which classifies sites into groups of dryland sites
#'
#' @param NPERM 
#' @param path_output 
#'
...
#' @export 
#'
#' @examples function_make_branches_data50(NPERM,path_output)


function_make_branches_data50 <- function(NPERM,path_output){
