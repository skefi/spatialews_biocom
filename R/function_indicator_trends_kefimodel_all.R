...
#' @export 
#'
#' @examples function_indicator_trends_kefimodel_all(NPERM,N_SHUFFLE,path_output,BOOTN,ALPHA)


function_indicator_trends_kefimodel_all <- function(NPERM,N_SHUFFLE,path_output,BOOTN,ALPHA){
  ...
  #unique(model_indics_fmt$simu_type)
  ...
  model_indics_fmt <- subset(model_indics_fmt_tot,simu_type=="original")
  ...
  filename = paste0("trends_kefimodel_fac_Nperm_",NPERM,"_Bootn_",BOOTN,"_rev.rda")
  ...
  #---------------------------------------------------------------------------
  #---------------------------------------------------------------------------
  # Model no fac glob disp
  #---------------------------------------------------------------------------
  #---------------------------------------------------------------------------
  
  model_indics_fmt <- subset(model_indics_fmt_tot,simu_type=="no_facil_global_disp")
  ...
  filename = paste0("trends_kefimodel_nofacglob_Nperm_",NPERM,"_Bootn_",BOOTN,"_rev.rda")
  save(model_trends, model_trends_med, model_trends_diffs_distribs, model_trends_diffs, 
       file = file.path(path_output,filename))
  ...
  #---------------------------------------------------------------------------
  #---------------------------------------------------------------------------
  # Model no fac local disp
  #---------------------------------------------------------------------------
  #---------------------------------------------------------------------------
  
  model_indics_fmt <- subset(model_indics_fmt_tot,simu_type=="no_facil_global_disp_local_comp")
  ...
  filename = paste0("trends_kefimodel_nofacloc_Nperm_",NPERM,"_Bootn_",BOOTN,"_rev.rda")
  save(model_trends, model_trends_med, model_trends_diffs_distribs, model_trends_diffs, 
       file = file.path(path_output,filename))
