...
#' @export 
#'
#' @examples function_compute_indicators(NPERM,path_output)


function_compute_indicators <- function(NPERM,path_output){
  ...
  indic_results <- spatialwarnings::compute_indicator(ourdata[["matrices"]], 
                                                      fun = all_indicf,
