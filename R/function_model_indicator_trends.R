...
#' @export 
#'
#' @examples function_model_indicator_trends(NPERM,N_SHUFFLE,path_output,BOOTN,ALPHA)


function_model_indicator_trends <- function(NPERM,N_SHUFFLE,path_output,BOOTN,ALPHA){
